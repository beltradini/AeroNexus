...
public struct HTTPProvider: FlightProvider {
    public let name: String
    public let baseURL: URI
    public init(name: String, baseURL: URI) {
        self.name = name
        self.baseURL = baseURL
    }

    public func fetchUpdates(req: Request) async throws -> [Any] {
    ...
    public func normalize(_ payload: Any, req: Request) throws -> FlightUpdatePacket {
