...
public class TimelineGenerator: @unchecked Sendable {
    // Dependencies
    ...
    init(flightService: any FlightService, calculator: TimelineCalculator, validator: TimelineValidator) {
